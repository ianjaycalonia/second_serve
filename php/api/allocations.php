    ...
    switch ($action) {
        ...
        case 'notify_run':
            ...
            try {
                ...
                // No-op status change for now; UI will send per-recipient notifications separately.
                // You can add a "notified_at" column to allocation_runs later and set it here if needed.
